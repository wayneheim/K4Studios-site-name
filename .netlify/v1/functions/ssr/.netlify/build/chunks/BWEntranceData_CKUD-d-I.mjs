...
/* empty css                        */
/* empty css                        */
import { g as galleryData$1 } from './Black-White_CacyG34n.mjs';
/* empty css                        */
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            title: "Close",
                            style: { minWidth: 32, minHeight: 32, fontWeight: 400 },
                            onClick: () => window.location.href = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Roaring-20s-Portraits/Black-White",
                            children: "⨂"
                          }
                        )
                      ]
...
const $$GalleryShellRoaring20SBW = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryShellRoaring20SBW;
  const { breadcrumb, entranceData, initialImageId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Facing History: Roaring 20s \u2013 BW Photos", "data-astro-cid-jntm55rl": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section id="gallery-shell" class="flex flex-col bg-white" data-astro-cid-jntm55rl> <div id="gallery-content" class="flex-grow relative overflow-hidden" data-astro-cid-jntm55rl> <!-- Header stays fixed above intro --> <div id="header-section" class="section-visible" style="z-index: 10; position: relative;" data-astro-cid-jntm55rl> ${renderComponent($$result2, "GalleryHeader", GalleryLandingHeader, { "client:load": true, "breadcrumb": breadcrumb, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Gallery-LandingHeader.jsx", "client:component-export": "default", "data-astro-cid-jntm55rl": true })} </div> <!-- Spacer to push intro below header visually --> <div class="h-0 md:h-5" data-astro-cid-jntm55rl></div> <!-- Intro: Visible initially, now loads under the header --> <div id="intro-section" class="section-visible" style="z-index: 1; position: relative;" data-astro-cid-jntm55rl> ${renderComponent($$result2, "GalleryInfo", GalleryInfo, { "client:load": true, "entranceData": entranceData, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryInfo.jsx", "client:component-export": "default", "data-astro-cid-jntm55rl": true })} </div> <!-- Chapter Viewer: Hidden initially --> <div id="chapter-section" class="section-hidden" style="display: none;" data-astro-cid-jntm55rl> ${renderComponent($$result2, "ChapterViewer", ScrollFlipGallery, { "client:load": true, "initialImageId": initialImageId || "i-k4studios", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Chapter-Roaring20sBW.jsx", "client:component-export": "default", "data-astro-cid-jntm55rl": true })} </div> </div> <!-- Spacer pushes the footer down on landing page --> <div class="h-12 md:h-20" data-astro-cid-jntm55rl></div> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-jntm55rl": true })} </section>  ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Roaring20s-BW.astro?astro&type=script&index=0&lang.ts")}   ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Roaring20s-BW.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Roaring20s-BW.astro", void 0);
...
const entranceData = {
  ...
  description: "Step into history with striking black and white Roaring 20s portraits that blend emotional storytelling with painterly texture. Wayne Heim’s fine art photography turns reenacted moments into expressive monochrome works steeped in realism and reverence.",
  details: "These black and white Roaring 20s portraits capture Union and Confederate reenactors in haunting detail. Each image reflects Wayne Heim’s painterly approach — transforming historically inspired scenes into collectible fine art. Ideal for history buffs, Roaring 20s collectors, and fans of painterly fine art photography. Also explore companion works in our bw Roaring 20s series, the broader Facing History project, or our black and white Western cowboy portraits for a parallel view into America’s past.",
  image: {
...
export { $$GalleryShellRoaring20SBW as $, entranceData as e };
