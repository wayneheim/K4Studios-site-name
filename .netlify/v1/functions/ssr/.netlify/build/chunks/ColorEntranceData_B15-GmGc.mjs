...
/* empty css                        */
/* empty css                        */
import { g as galleryData$1 } from './Color_CB1i983B.mjs';
/* empty css                        */
...
function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color";
...
const $$GalleryShellCowboyColor = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryShellCowboyColor;
  const { breadcrumb, entranceData, initialImageId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Facing History: Western Art \u2013 Color Photos", "data-astro-cid-o7gtnej6": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section id="gallery-shell" class="flex flex-col bg-white" data-astro-cid-o7gtnej6> <div id="gallery-content" class="flex-grow relative overflow-hidden" data-astro-cid-o7gtnej6> <!-- Header stays fixed above intro --> <div id="header-section" class="section-visible" style="z-index: 10; position: relative;" data-astro-cid-o7gtnej6> ${renderComponent($$result2, "GalleryHeader", GalleryLandingHeader, { "client:load": true, "breadcrumb": breadcrumb, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Gallery-LandingHeader.jsx", "client:component-export": "default", "data-astro-cid-o7gtnej6": true })} </div> <!-- Spacer to push intro below header visually --> <div class="h-0 md:h-5" data-astro-cid-o7gtnej6></div> <!-- Intro: Visible initially, now loads under the header --> <div id="intro-section" class="section-visible" style="z-index: 1; position: relative;" data-astro-cid-o7gtnej6> ${renderComponent($$result2, "GalleryInfo", GalleryInfo, { "client:load": true, "entranceData": entranceData, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryInfo.jsx", "client:component-export": "default", "data-astro-cid-o7gtnej6": true })} </div> <!-- Chapter Viewer: Hidden initially --> <div id="chapter-section" class="section-hidden" style="display: none;" data-astro-cid-o7gtnej6> ${renderComponent($$result2, "ChapterViewer", ScrollFlipGallery, { "client:load": true, "initialImageId": initialImageId || "i-k4studios", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Chapter-CowboyColor.jsx", "client:component-export": "default", "data-astro-cid-o7gtnej6": true })} </div> </div> <!-- Spacer pushes the footer down on landing page --> <div class="h-12 md:h-20" data-astro-cid-o7gtnej6></div> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-o7gtnej6": true })} </section>  ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-Color.astro?astro&type=script&index=0&lang.ts")}   ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-Color.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-Color.astro", void 0);
...
const entranceData = {
  ...
  description: "Discover a painterly take on cowboy photography that brings the color and grit of the frontier to life. Wayne Heim's Western art prints are more than portraits — they are vivid stories etched in sun, shadow, and dust.",
  details: "These color cowboy photographs are captured with the soul of the American West in mind—no studio backdrops, no Hollywood tropes. Just real cowboys, historic reenactors, and the spirit of wide-open spaces. Printed using painterly techniques, these works blend the realism of photography with the brushlike textures of illustration.",
  image: {
...
export { $$GalleryShellCowboyColor as $, entranceData as e };
