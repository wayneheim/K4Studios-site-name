...
/* empty css                        */
/* empty css                        */
import { g as galleryData$1 } from './Black-White_BdpB_JkH.mjs';
/* empty css                        */
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            title: "Close",
                            style: { minWidth: 32, minHeight: 32, fontWeight: 400 },
                            onClick: () => window.location.href = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color",
                            children: "⨂"
                          }
                        )
                      ]
        ...
        /* @__PURE__ */ jsx(SwipeHint, { galleryKey: "Painterly-Cowboy-Color" })
      ]
    }
  );
}
...
const $$GalleryShellCowboyBW = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryShellCowboyBW;
  const { breadcrumb, entranceData, initialImageId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Facing History: Western Art \u2013 Color Photos", "data-astro-cid-kzlogz4o": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section id="gallery-shell" class="flex flex-col bg-white" data-astro-cid-kzlogz4o> <div id="gallery-content" class="flex-grow relative overflow-hidden" data-astro-cid-kzlogz4o> <!-- Header stays fixed above intro --> <div id="header-section" class="section-visible" style="z-index: 10; position: relative;" data-astro-cid-kzlogz4o> ${renderComponent($$result2, "GalleryHeader", GalleryLandingHeader, { "client:load": true, "breadcrumb": breadcrumb, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Gallery-LandingHeader.jsx", "client:component-export": "default", "data-astro-cid-kzlogz4o": true })} </div> <!-- Spacer to push intro below header visually --> <div class="h-0 md:h-5" data-astro-cid-kzlogz4o></div> <!-- Intro: Visible initially, now loads under the header --> <div id="intro-section" class="section-visible" style="z-index: 1; position: relative;" data-astro-cid-kzlogz4o> ${renderComponent($$result2, "GalleryInfo", GalleryInfo, { "client:load": true, "entranceData": entranceData, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryInfo.jsx", "client:component-export": "default", "data-astro-cid-kzlogz4o": true })} </div> <!-- Chapter Viewer: Hidden initially --> <div id="chapter-section" class="section-hidden" style="display: none;" data-astro-cid-kzlogz4o> ${renderComponent($$result2, "ChapterViewer", ScrollFlipGallery, { "client:load": true, "initialImageId": initialImageId || "i-k4studios", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Chapter-CowboyBW.jsx", "client:component-export": "default", "data-astro-cid-kzlogz4o": true })} </div> </div> <!-- Spacer pushes the footer down on landing page --> <div class="h-12 md:h-20" data-astro-cid-kzlogz4o></div> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-kzlogz4o": true })} </section>  ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-BW.astro?astro&type=script&index=0&lang.ts")}   ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-BW.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-Cowboy-BW.astro", void 0);

const entranceData = {
  title: "Cowboy Art Prints by Wayne Heim - Authentic Western Fine Art Photography in Black and White",
  subtitle: "Capturing the Spirit of the Old American West",
  description: "Discover a painterly take on cowboy photography that brings the black and white tones and the grit of the frontier to life. Wayne Heim's Western art prints are more than portraits — they are vivid stories seasoned in the sun, shadow, and dust of the West.",
  details: "These black and white cowboy photographs are captured with the soul of the American West in mind—no studio backdrops, no Hollywood tropes. Just real cowboys, historic reenactors, and the spirit of wide-open spaces. Developed using Wayne's painterly photographic techniques, these works blend the realism of photography with the brushlike textures of illustration and fine art painting.",
  image: {
  ...
  breadcrumb: "Western Cowboy Portraits | Black & White"
};

export { $$GalleryShellCowboyBW as $, entranceData as e };
