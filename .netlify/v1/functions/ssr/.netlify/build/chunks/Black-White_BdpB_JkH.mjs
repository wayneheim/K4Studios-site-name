const galleryData = [
  ...
  {
    "id": "i-2VTWJ3R",
    "title": "Cowboy Portraits in Black and White: Roping Livestock on the Homestead",
    "description": "Take a step back in time with this captivating black and white cowboy portrait, capturing the intense moment of a cowboy roping livestock on a homestead. Wayne Heim’s fine art photography beautifully conveys the untamed spirit of the Old West through striking cowboy portraits that blend emotion and history. Using a unique painterly style, Wayne captures the raw energy of the frontier with high ISO techniques that create a grainy texture, giving the image a timeless, vintage feel. This approach adds depth and warmth, elevating each photograph to a fine art masterpiece. Perfect for any wall art collection, this piece transports you to the heart of cowboy life, allowing you to experience the power and rugged beauty of the Wild West. With its high-quality print options, this work of art is ideal for those who appreciate both historical authenticity and artistic expression. © Wayne Heim",
    ...
    "story": "Take a step back in time with this captivating black and white cowboy portrait, capturing the intense moment of a cowboy roping livestock on a homestead. Wayne Heim’s fine art photography beautifully conveys the untamed spirit of the Old West through striking cowboy portraits that blend emotion and history. Using a unique painterly style, Wayne captures the raw energy of the frontier with high ISO techniques that create a grainy texture, giving the image a timeless, vintage feel. This approach adds depth and warmth, elevating each photograph to a fine art masterpiece. Perfect for any wall art collection, this piece transports you to the heart of cowboy life, allowing you to experience the power and rugged beauty of the Wild West. With its high-quality print options, this work of art is ideal for those who appreciate both historical authenticity and artistic expression. © Wayne Heim",
    "notes": "A sense of momentum defines this portrait, with the lasso’s arc guiding the viewer into the frame and the subject’s composed gaze holding them there. Light and shadow are carefully balanced to evoke a quiet tension, while the nuanced treatment of fabric textures and the softened background adds a subtle, cinematic drama. \n\n \n\n What truly distinguishes this work is the intentional use of painterly photography. Texture and tone aren’t mere effects—they’re woven into the storytelling, dissolving the boundaries of the present moment. The unique presentation draws the viewer into the narrative, encouraging them to let go of the reality of “looking at a picture” and instead step inside the unfolding scene. In this way, the image becomes less a static record and more an invitation to experience a living, breathing moment of the West.",
    "rating": 5,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  },
  {
    ...
    "notes": "This portrait is a study in narrative composition. The subject’s stance—anchored but alert—echoes classic themes in Western art, conjuring both myth and lived experience. Notice how the lines of the saddle and rope draw the viewer’s gaze diagonally across the frame, lending energy and cohesion to the scene. The doorway’s dark negative space not only frames the cowboy but also grounds him within a tangible sense of place, reinforcing authenticity.\n\n \n\n Texture is handled with intention: the interplay of rough-hewn wood, worn leather, and denim introduces layers of tactile interest that reward close viewing. The soft focus at the edges and careful tonality suggest a moment lifted out of time, nodding to both vintage photographic processes and painterly traditions.\n\n \n\n What sets this piece apart is its balance of storytelling and restraint; nothing feels staged or exaggerated, allowing the subject’s presence and the subtleties of craftsmanship to speak for themselves. For the collector, this is an image that stands up to repeated study—rooted in the best traditions of Western visual storytelling, yet rendered with a modern artist’s sensitivity to light, material, and mood.",
    "rating": 4,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  },
  {
    ...
    "notes": "This image exemplifies sophisticated use of selective focus and tonal gradation, tools often reserved for fine art portraiture but rarely so sensitively applied in Western photography. The shallow depth of field isolates the subjects from the rustic background, directing the viewer’s gaze precisely to the point of emotional connection—the gentle press of cheek to muzzle. \n\n \n\n The placement of the figures within the frame uses negative space to emphasize intimacy without crowding, while the softened contrast subtly compresses the dynamic range. This creates a print that glows from within, rather than relying on hard-edged highlights or deep shadow. Note the delicate highlight on the subject’s hair and the velvety rendering of the horse’s coat—both achieved by careful control of light and exposure. \n\n \n\n Subtle textural overlays and painterly post-processing techniques further distinguish this piece. Rather than serving as ornamentation, these choices unify the image, echoing historic photographic processes and adding depth without distraction. For collectors, this work demonstrates an intentional blend of classic technique and modern storytelling—a quiet statement of craftsmanship and vision.",
    "rating": 3,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  },
  {
    ...
    "notes": "Within the broad field of Western photography, this piece stands out for its refusal to rely on nostalgia or cliché. While many works in the genre capture costume or setting, this portrait elevates the tradition through a painterly approach to light, tone, and atmosphere—eschewing mere documentation for something more evocative. \n\n \n\n What distinguishes this image is its sensitive balance of technical precision and artistic interpretation. The soft diffusion of light and carefully layered textures are not simply stylistic choices, but intentional tools that invite the viewer into the subject’s world. The scene feels less like a re-enactment and more like a rediscovered memory, blurring the boundary between present and past. \n\n \n\n The use of painterly photography techniques—subtle in execution, purposeful in effect—gives the piece an emotional resonance rarely seen in Western imagery. It’s not just about what is shown, but how it’s felt: the viewer is invited to participate in the story, not simply observe it. \n\n \n\n  For the collector, this image is unique in its ability to merge the authenticity of Western art with the expressive power of fine art photography. It stands as an example of how the genre can move beyond surface narrative, offering a nuanced and enduring experience for those who seek something more than a mere window to the past.",
    "rating": 5,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  },
  {
    ...
    "notes": "A classic Western archetype comes alive here—not through action, but through atmosphere and character. The composition draws strength from restraint: the sheriff framed by shadowed timber, posture relaxed but alert, suggesting a narrative poised on the edge of unfolding.\n\nWhat elevates this work within the Western genre is its cinematic approach to light and structure. The diagonal lines of porch and roof add tension and depth, while the interplay of shadow and highlight evokes both the grit and gravitas of frontier life. There’s no overstatement—just a quiet sense of story, as if the viewer has stumbled onto a moment rather than a staged tableau.\n\nThe painterly handling of tone and texture subtly distinguishes this image from traditional Western photography. Rather than simply document, the technique imparts a sense of memory—softening edges, layering time, and drawing the viewer deeper into the narrative. This piece doesn’t just show the West; it remembers it, making it a distinctive addition for any collector seeking work that honors both tradition and artistic innovation.",
    "rating": 4,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  },
  {
    ...
    "notes": "This portrait captures the timeless presence of the frontier woman—steadfast, contemplative, and full of quiet resilience. The subject’s posture, with hands gently clasped and gaze turned toward the light, conveys both strength and reflection, drawing the viewer into her world rather than holding them at a distance.\n\nWhat sets this image apart within Western photography is its use of controlled soft focus and tonal gradation, which subtly dissolve the boundaries between subject and setting. The painterly textures and delicate highlights are not simply nostalgic effects; rather, they serve as intentional artistic choices, emphasizing memory, atmosphere, and the lived-in authenticity of the era. For collectors, this photograph stands as an evocative example of contemporary Western art—one that honors the genre’s tradition while reimagining its possibilities through craft and vision.",
    "rating": 5,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  {
    "id": "i-TpqkCVk",
    "title": "Dawn Showdown – Black and White Cowboy Portrait Photography",
    "description": "This black and white cowboy portrait blends timeless artistry with the storytelling tradition of classic western photography. The subject’s quiet strength and contemplative pose evoke the spirit of the Old West, while painterly photography techniques add subtle texture and drama, setting this piece apart from typical western photos. \n\nAs a fine art cowboy photograph, this work appeals to collectors who value authentic black and white western art, vintage western themes, and the enduring mystique of cowboy culture. The careful play of light and shadow not only pays homage to historical western portraiture but also creates a striking centerpiece for man cave decor or any space seeking to capture the rugged beauty of the American frontier. \n\nDiscover more black and white cowboy art and explore the collection of painterly western photography for a unique addition to your western wall art collection.",
    "alt": "Black and white cowboy portrait at dawn, tense showdown in the Old West. Fine art Western photography capturing the drama of vintage cowboy life.",
    ...
    "story": "A cool hush lingers over the high country, dew still clinging to the grass. At the boundary of dawn, he stands with the weight of silence on his shoulders, gaze fixed somewhere between memory and horizon. Dust and longing mingle on his shirt sleeves, a restless story trailing behind as he drifts through the quiet, sifting the possibilities of all that waits just beyond the morning.",
    "notes": "A compelling sense of character comes through in this portrait, where the subject’s direct gaze and confident bearing suggest both individuality and archetype—a figure at once rooted in the mythology of the West and alive in the present moment. The photograph’s composition, with its off-center framing and generous negative space, lends an almost cinematic quality, allowing the viewer’s attention to linger on the intricate details of costume and expression. \n\nThe distinctive surface textures and nuanced tonal transitions—hallmarks of painterly photographic technique—elevate the image beyond straightforward documentation. Instead, these choices invite the collector to appreciate the craft and intention behind the work: the interplay of light, atmosphere, and historical narrative, distilled into a single, memorable vision.",
    "rating": 4,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
  ...
  {
    "id": "i-qMQf7b6",
    "title": "Ready for Anything in the Old West",
...
export { __vite_glob_0_13 as _, galleryData as g };
