...
import 'kleur/colors';
import { $ as $$Footer, a as $$BaseLayout } from './Footer_VeJuj4uH.mjs';
...
/* empty css                        */
/* empty css                        */
import { g as galleryData$1 } from './Black-White_KdVP8gLQ.mjs';
/* empty css                        */
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(SwipeHint, { galleryKey: "Painterly-CivilWar-BlackWhite" })
      ]
    }
  );
}
...
const $$GalleryShellCivilWarBW = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryShellCivilWarBW;
  const { breadcrumb, entranceData, initialImageId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Facing History: Civil War Themed Art \u2013 Color Photos", "data-astro-cid-annx4clk": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section id="gallery-shell" class="flex flex-col bg-white" data-astro-cid-annx4clk> <div id="gallery-content" class="flex-grow relative overflow-hidden" data-astro-cid-annx4clk> <!-- Header stays fixed above intro --> <div id="header-section" class="section-visible" style="z-index: 10; position: relative;" data-astro-cid-annx4clk> ${renderComponent($$result2, "GalleryHeader", GalleryLandingHeader, { "client:load": true, "breadcrumb": breadcrumb, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Gallery-LandingHeader.jsx", "client:component-export": "default", "data-astro-cid-annx4clk": true })} </div> <!-- Spacer to push intro below header visually --> <div class="h-0 md:h-5" data-astro-cid-annx4clk></div> <!-- Intro: Visible initially, now loads under the header --> <div id="intro-section" class="section-visible" style="z-index: 1; position: relative;" data-astro-cid-annx4clk> ${renderComponent($$result2, "GalleryInfo", GalleryInfo, { "client:load": true, "entranceData": entranceData, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryInfo.jsx", "client:component-export": "default", "data-astro-cid-annx4clk": true })} </div> <!-- Chapter Viewer: Hidden initially --> <div id="chapter-section" class="section-hidden" style="display: none;" data-astro-cid-annx4clk> ${renderComponent($$result2, "ChapterViewer", ScrollFlipGallery, { "client:load": true, "initialImageId": initialImageId || "i-k4studios", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Chapter-CivilWarBW.jsx", "client:component-export": "default", "data-astro-cid-annx4clk": true })} </div> </div> <!-- Spacer pushes the footer down on landing page --> <div class="h-12 md:h-20" data-astro-cid-annx4clk></div> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-annx4clk": true })} </section>  ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-BW.astro?astro&type=script&index=0&lang.ts")}   ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-BW.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-BW.astro", void 0);
...
const entranceData = {
  ...
  description: "Step into history with striking black and white Civil War portraits that blend emotional storytelling with painterly texture. Wayne Heim’s fine art photography turns reenacted moments into expressive monochrome works steeped in realism and reverence.",
  details: "These black and white Civil War portraits capture Union and Confederate reenactors in haunting detail. Each image reflects Wayne Heim’s painterly approach — transforming historically inspired scenes into collectible fine art. Ideal for history buffs, Civil War collectors, and fans of painterly fine art photography. Also explore companion works in our color Civil War series, the broader Facing History project, or our black and white Western cowboy portraits for a parallel view into America’s past.",
  image: {
    ...
    alt: "Cowboy Portrait Preview",
    caption: '"Difficult Decisions"'
  },
  breadcrumb: "Civil War Portraits | Black & White"
};

export { $$GalleryShellCivilWarBW as $, entranceData as e };
