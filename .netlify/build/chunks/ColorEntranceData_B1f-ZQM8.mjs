...
/* empty css                        */
/* empty css                        */
import { g as galleryData$1 } from './Color_B0tZ5rnE.mjs';
/* empty css                        */
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(SwipeHint, { galleryKey: "Painterly-CivilWar-Color" })
      ]
    }
  );
}
...
const $$GalleryShellCivilWarColor = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryShellCivilWarColor;
  const { breadcrumb, entranceData, initialImageId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Facing History: Civil War Themed Art \u2013 Color Photos", "data-astro-cid-vwfvwbwa": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section id="gallery-shell" class="flex flex-col bg-white" data-astro-cid-vwfvwbwa> <div id="gallery-content" class="flex-grow relative overflow-hidden" data-astro-cid-vwfvwbwa> <!-- Header stays fixed above intro --> <div id="header-section" class="section-visible" style="z-index: 10; position: relative;" data-astro-cid-vwfvwbwa> ${renderComponent($$result2, "GalleryHeader", GalleryLandingHeader, { "client:load": true, "breadcrumb": breadcrumb, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Gallery-LandingHeader.jsx", "client:component-export": "default", "data-astro-cid-vwfvwbwa": true })} </div> <!-- Spacer to push intro below header visually --> <div class="h-0 md:h-5" data-astro-cid-vwfvwbwa></div> <!-- Intro: Visible initially, now loads under the header --> <div id="intro-section" class="section-visible" style="z-index: 1; position: relative;" data-astro-cid-vwfvwbwa> ${renderComponent($$result2, "GalleryInfo", GalleryInfo, { "client:load": true, "entranceData": entranceData, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryInfo.jsx", "client:component-export": "default", "data-astro-cid-vwfvwbwa": true })} </div> <!-- Chapter Viewer: Hidden initially --> <div id="chapter-section" class="section-hidden" style="display: none;" data-astro-cid-vwfvwbwa> ${renderComponent($$result2, "ChapterViewer", ScrollFlipGallery, { "client:load": true, "initialImageId": initialImageId || "i-k4studios", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Chapter-CivilWarColor.jsx", "client:component-export": "default", "data-astro-cid-vwfvwbwa": true })} </div> </div> <!-- Spacer pushes the footer down on landing page --> <div class="h-12 md:h-20" data-astro-cid-vwfvwbwa></div> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-vwfvwbwa": true })} </section>  ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-Color.astro?astro&type=script&index=0&lang.ts")}   ${renderScript($$result2, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-Color.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/GalleryShell-CivilWar-Color.astro", void 0);
...
const entranceData = {
  ...
  description: "Explore vivid and emotional Civil War art prints that blend historical accuracy with painterly expression. Wayne Heim’s color portraits of Civil War reenactors are crafted with a fine art touch — turning battlefield moments and solemn reflections into collectible photographic artwork.",
  details: "Civil War art prints, Civil War photography, and historical reenactment portraits captured in vivid painterly color. These fine art photographs feature Civil War reenactors, Union and Confederate soldier portraits, and historically inspired wall art for collectors, interior designers, and history enthusiasts. Ideal for themed home decor, Civil War gifts, and Americana fine art collections. Wayne Heim’s painterly photography technique blends realism with texture — creating museum-quality Civil War portraiture with modern clarity and timeless appeal.",
  image: {
    ...
    alt: "Painterly Civil War reenactor standing guard in color",
    caption: '"Standing Guard"'
  },
  breadcrumb: "Civil War Portraits | Color"
};

export { $$GalleryShellCivilWarColor as $, entranceData as e };
