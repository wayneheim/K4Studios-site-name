...
import { c as createComponent, d as createAstro, r as renderTemplate, k as renderSlot, i as renderComponent, m as maybeRenderHead, f as addAttribute, u as unescapeHTML } from '../../../../chunks/astro/server_DU4U1nxe.mjs';
import 'kleur/colors';
import { a as $$BaseLayout, s as siteNav, $ as $$Footer } from '../../../../chunks/Footer_VeJuj4uH.mjs';
import { g as getSideImages } from '../../../../chunks/getSideImages_BV_7qGbl.mjs';
import { a as autoLinkKeywordsInText } from '../../../../chunks/autoLinkKeywordsInText_DoBYihv7.mjs';
/* empty css                                         */
/* empty css                                                          */
/* empty css                                         */
  ...
  tombstones: [
    {
      ...
      thumb: "https://photos.smugmug.com/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/War/Color/i-LN9Tdvr/0/MB5wDRMswbzWhWNwfvFscsmB2Z9BNKb3Px3RV45xC/S/_O1H2732-Edit-S.jpg"
    },
    {
      title: "Men and Machines",
      href: "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Machines",
      thumb: "https://photos.smugmug.com/Other/Photo-Shoots/Miscellaneous-Collections/Historic-Reenactments/D-Day-Conneaut-2017/i-K2qMML6/3/KHWdtwHrrgq2KjMrvPDMtCwHW7fMNdW3D6gn4LrtN/S/_OLY1169-Edit-S.jpg"
    },
    {
      title: "Portraits and People",
      href: "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits",
      thumb: "https://photos.smugmug.com/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits/Color/i-S5mtbjv/2/KjBvjNQxbpnG6bh7TRQTTf5K2NWwtFt4ZtX79b5dn/S/_OLY2851-Edit-S.jpg"
    }
  ]
};
...
const $$WWII = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$WWII;
  const sectionPath = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII";
  ...
  const featheredImages = getSideImages({ sectionPath, headingCount});
  return renderTemplate(_a || (_a = __template([">\n", '<script>\n  document.addEventListener("DOMContentLoaded", () => {\n    // Reveal-on-scroll logic\n    const els = document.querySelectorAll(".reveal-on-scroll, .slide-in-left");\n    if ("IntersectionObserver" in window) {\n      const observer = new IntersectionObserver(entries => {\n        entries.forEach(entry => {\n          if (entry.isIntersecting) {\n            entry.target.classList.add("is-visible");\n            observer.unobserve(entry.target);\n          }\n        });\n      }, {\n        threshold: 0.15\n      });\n      els.forEach(el => observer.observe(el));\n    }\n\n    // NEW: auto-expand FAQ box if a question is clicked\n    const faqToggle = document.getElementById("faq-toggle");\n    const truncateContainer = document.querySelector(".truncate-container");\n\n    if (truncateContainer && faqToggle) {\n      truncateContainer.addEventListener("click", (e) => {\n        const summaryClicked = e.target.closest("summary");\n        if (summaryClicked && !faqToggle.checked) {\n          faqToggle.checked = true;\n        }\n      });\n    }\n  });\n<\/script> <body data-astro-cid-d3s6gsuz> <div class="page-container" data-astro-cid-d3s6gsuz> ', ' </div> <div id="overlay-root" data-astro-cid-d3s6gsuz></div> </body>'])), renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": `${landingWestern.title} \u2013 ${landingWestern.subtitle}`, "data-astro-cid-d3s6gsuz": true }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<main class="bg-[#fdfcf9] text-[#2c2c2c] font-serif min-h-screen overflow-x-hidden" data-astro-cid-d3s6gsuz><div class="drawer-mode" data-astro-cid-d3s6gsuz>${renderComponent($$result2, "LandingHeader", LandingHeader, { "client:load": true, "breadcrumb": "Facing History \u2022 Roaring 20's Portraits", "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/Landing-Header.jsx", "client:component-export": "default", "data-astro-cid-d3s6gsuz": true })}</div><div class="mobile-breadcrumb-wrapper" data-astro-cid-d3s6gsuz><div class="mobile-breadcrumb" data-astro-cid-d3s6gsuz>${landingWestern.breadcrumb}</div></div><div class="w-full max-w-[1200px] mx-auto px-4" data-astro-cid-d3s6gsuz><div class="carousel-fade reveal-on-scroll" data-astro-cid-d3s6gsuz>${renderComponent($$result2, "ImageBar2", ImageBar2, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/ImageBar2.jsx", "client:component-export": "default", "data-astro-cid-d3s6gsuz": true })}</div></div><section class="section-heading-wrap" data-astro-cid-d3s6gsuz><div class="section-heading" data-astro-cid-d3s6gsuz><h1 class="page-title fade-in reveal-on-scroll" data-astro-cid-d3s6gsuz>${landingWestern.title}</h1><h2 class="page-subtitle fade-in reveal-on-scroll" data-astro-cid-d3s6gsuz>${landingWestern.subtitle}</h2></div></section><div class="py-5" data-astro-cid-d3s6gsuz>${renderComponent($$result2, "TombstoneNav", TombstoneNav, { "items": landingWestern.tombstones, "data-astro-cid-d3s6gsuz": true })}</div><section class="story-layout" data-astro-cid-d3s6gsuz><div class="text-column" data-astro-cid-d3s6gsuz><section class="story-section" data-astro-cid-d3s6gsuz>${westernStory.map((section, index) => renderTemplate`<article class="story-block"${addAttribute(index, "key")} data-astro-cid-d3s6gsuz>${section.title && renderTemplate`<h2 class="slide-in-left" data-astro-cid-d3s6gsuz>${unescapeHTML(autoLinkKeywordsInText(section.title, galleryDatas, featheredImages, galleryPaths))}</h2>`}${section.subhead && renderTemplate`<h3 class="slide-in-left" data-astro-cid-d3s6gsuz>${unescapeHTML(autoLinkKeywordsInText(section.subhead, galleryDatas, featheredImages, galleryPaths))}</h3>`}${section.tagline && renderTemplate`<h4 class="tagline reveal-on-scroll" data-astro-cid-d3s6gsuz>${unescapeHTML(autoLinkKeywordsInText(section.tagline, galleryDatas, featheredImages, galleryPaths))}</h4>`}${section.paragraphs?.map((para, i) => renderTemplate`<p${addAttribute(i, "key")} class="reveal-on-scroll" data-astro-cid-d3s6gsuz>${unescapeHTML(autoLinkKeywordsInText(para, galleryDatas, featheredImages, galleryPaths))}</p>`)}${section.list && section.list.length > 0 && renderTemplate`<ul data-astro-cid-d3s6gsuz>${section.list.map((item, j) => renderTemplate`<li${addAttribute(j, "key")} class="reveal-on-scroll" data-astro-cid-d3s6gsuz>${unescapeHTML(autoLinkKeywordsInText(item, galleryDatas, featheredImages, galleryPaths))}</li>`)}</ul>`}</article>`)}</section>${renderComponent($$result2, "MobileStoryImages", null, { "client:only": "react", "images": featheredImages, "client:component-hydration": "only", "data-astro-cid-d3s6gsuz": true, "client:component-path": "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/components/MobileStoryImages.jsx", "client:component-export": "default" })}</div><div class="sidebar-column hidden md:block" data-astro-cid-d3s6gsuz><div class="sample-fade reveal-on-scroll" data-astro-cid-d3s6gsuz>${renderComponent($$result2, "LandingRightImages", LandingRightImages, { "heading": "Featured Portraits", "images": featheredImages.slice(0, 5), "data-astro-cid-d3s6gsuz": true })}</div></div></section><section class="pb-16" data-astro-cid-d3s6gsuz><input type="checkbox" id="faq-toggle" class="more-toggle" data-astro-cid-d3s6gsuz><div class="truncate-container" data-astro-cid-d3s6gsuz><div class="truncate-text" data-astro-cid-d3s6gsuz>${renderComponent($$result2, "FAQAccordion", FAQAccordion, { "items": westernFAQ, "data-astro-cid-d3s6gsuz": true })}</div></div><label for="faq-toggle" class="more-toggle-label" data-astro-cid-d3s6gsuz></label></section>${renderComponent($$result2, "SiteFooter", $$Footer, { "class": "pt-8 pb-12", "data-astro-cid-d3s6gsuz": true })}</main>` }), renderSlot($$result, $$slots["default"]));
}, "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/pages/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII.astro", void 0);

const $$file = "C:/Users/Wayne/Documents/GitHub/K4-Studios/src/pages/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII.astro";
const $$url = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII";
