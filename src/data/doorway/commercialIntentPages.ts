...
The tradition that Russell and Remington established and that serious Western collectors have been building around for generations is available as fine art prints. Starting at ${getFormattedLowestStandardPrintPrice()}. Built to last.`,
  ...
  womenOfTheWildWest: makePage({
    ...
    gatewaySupportingCopy:
      `Women of the Wild West were not decorative witnesses to frontier life. They held households together, crossed distance, made decisions under pressure, endured isolation, defended boundaries, buried losses, kept accounts, raised children, worked land, and carried private histories that rarely became the official story.\n\nWayne Heim's frontier women portraits and narrative scenes are built around that missing center. The image may show a cowgirl, a wife, a daughter, a traveler, a widow, or a woman standing at the edge of an unfinished decision, but the point is not costume. The point is presence. These works ask what happens when the Western story is allowed to turn toward the women who absorbed its cost.\n\nThe collection can be entered through the small-format Sketch Series at ${getFormattedLowestStandardPrintPrice()}, then scaled into archival paper prints for rooms that need the figure to hold the wall. Selected works move into signed Chronicle and Legend editions with numbered certificates when the subject calls for collector treatment. A few images may also be offered as Signature Engrained Series natural Baltic Birch panels, especially when wood grain can deepen the historical surface around the figure.`,
    collectionIntro: "",
    gridIntroTitle: "",
    gridIntroCopy: "",
    descriptions: {
