export const westernStory = [
    /* ───────────────────────────────────────────── 1 */
  {
    ...
    paragraphs: [
      `Step into the world of <a href="/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits">WWII Portraits</a> — a collection capturing the courage and complexity of the men and women who shaped history. These painterly fine art portraits go beyond uniform and rank, revealing the raw emotion, camaraderie, and sacrifice behind every face.`,
  ...
  /* ───────────────────────────────────────────── 2 */
  {
    ...
    paragraphs: [
      `Each portrait in this series is inspired by true stories and reenacted by living historians. Every <a href="/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits">subject</a> is a person embodying the memory of a generation — not an actor in costume, but a keeper of history.`,
  ...
  /* ───────────────────────────────────────────── 3 */
  {
    ...
    list: [
      ...
      `Women in service: <a href="/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits">WACs, WAVES</a>, and nurses who broke boundaries.`,
