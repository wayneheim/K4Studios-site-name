...
export const galleryData = [
  ...
  },
  {
    ...
    "description": "A rugged cowboy pauses in the heart of a dusty Western town, the kind where saloons outnumber storekeepers and time moves with the sun. The warm, directional light and painterly tones capture the grit and humor of life in the Wild West, making this portrait both authentic and inviting for Western fine art collectors.",
    "alt": "Cowboy standing in a Western street, framed by wooden buildings, with sunlight casting long shadows.",
    ...
    "story": "This one-horse town’s got more bars than bakers. Guess either one will do for breakfast.",
    "notes": "Framed with a balance of negative space and strong vertical lines, the composition guides the eye directly to the subject’s posture and expression. The subdued yet deliberate color palette reinforces the sense of place without overpowering the narrative. This piece skillfully merges documentary realism with painterly artistry, offering a rare example of Western portraiture that resonates in both storytelling and fine art contexts.",
    "rating": 0,
    "galleries": [
      "Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Color"
    ],
