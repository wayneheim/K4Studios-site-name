...
export const galleryData = [
  ...
  },
  {
    ...
    "description": "The Weight of the Draw is a painterly Western fine art photograph that captures a Native American figure at full draw, suspended in the charged stillness before release. Rooted in pictorialist tradition and cinematic restraint, the image emphasizes physical tension, emotional focus, and the quiet authority of lived skill rather than spectacle.\n\nMuted tones, controlled contrast, and deliberate composition place the viewer inside the moment—where breath, muscle, and memory converge. This work reflects contemporary Western fine art photography that honors Indigenous presence with dignity, narrative weight, and respect for tradition.\n\n© Wayne Heim",
    "alt": "Painterly Western fine art photograph of a Native American figure drawing a bow, captured in a moment of focused stillness and restrained power.",
  ...
  },
  {
    ...
    "description": "Still Enough to Hear It is a painterly Western fine art photograph that captures a Native American figure in a moment of heightened awareness and restraint. Rooted in pictorialist tradition and cinematic minimalism, the image emphasizes vigilance, patience, and the discipline of attention over action or spectacle.\n\nRendered in a quiet monochrome palette, the composition draws the viewer into a psychological space where listening becomes the primary act. This work reflects contemporary Western fine art photography that honors Indigenous presence through dignity, control, and narrative depth rather than dramatization. © Wayne Heim",
    "alt": "Black and white painterly Western fine art photograph of a Native American figure holding a rifle, seated in stillness and focused attention within a natural landscape.",
  ...
  },
  {
    ...
    "description": "A painterly fine art photograph by Wayne Heim capturing a moment of disciplined stillness before action. Rather than depicting motion or impact, this image centers on vigilance, restraint, and the psychological weight of readiness. Rooted in the pictorialist tradition, the composition emphasizes presence over spectacle—where attention, breath, and intention converge. This work reflects Wayne Heim’s approach to Western and Native American fine art photography: narrative-driven, historically aware, and grounded in quiet authority. © Wayne Heim",
    "alt": "Native American archer holding a drawn bow in a moment of stillness, rendered in painterly fine art photography emphasizing restraint, focus, and presence.",
