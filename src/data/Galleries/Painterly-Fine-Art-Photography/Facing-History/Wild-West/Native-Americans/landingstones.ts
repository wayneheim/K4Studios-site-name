export const landingWestern = {
  ...
  subtitle: "Presence, heritage, and identity rendered through painterly color and black-and-white fine art.",
  ...
  keywords: [
    ...
    "Native American black and white photography",
    "Native American color portrait photography",
    "Facing History photography",
    "story driven Native American art",
    "Native American monochrome portrait photography"
  ],
  ...
  tombstones: [
    ...
    },
    {
      ...
      subtitle: "Color",
      href: "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Wild-West/Native-Americans/NA-Color/all?theme=na-narrative-color-images&view=grid#collection-browser",
      dockHref: "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Wild-West/Native-Americans/NA-Color/all?theme=na-narrative-color-images&view=grid#collection-browser",
      imageId: "i-7hD9CCh",
