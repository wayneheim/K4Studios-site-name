...
export const entranceData = {
  ...
  keywords: [
    "Western Traditional Landscapes",
    "Western Landscapes – Spirit",
    "Wyoming & Montana",
    "classic western landscape prints",
    "traditional western landscape photography",
  ...
  description: `
    ...
    <a href="/Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits"
       ...
       Western Cowboy Portraits</a>, where fine art portraiture brings the people of the frontier to life. If dramatic peaks are more your style, explore our 
  ...
  breadcrumb: 
    `<a href="/Galleries/Fine-Art-Photography/Landscapes/By-Location" style="color: inherit; text-decoration: none; cursor: pointer; pointer-events: auto; position: relative; z-index: 9999; transition: color 0.2s ease;" onmouseover="this.style.color='red'" onmouseout="this.style.color='inherit'">Landscapes by Location</a> | West`,
};
