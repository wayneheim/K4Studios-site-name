export const cowboyFAQ = [
  // 1. CONCEPT — Simple definition (Google-first)
  {
    q: "What is Western cowboy photography?",
    a: [
      "Western cowboy photography is a form of fine art photography focused on the people, culture, and frontier stories of the historic American West. Rather than staged spectacle, it emphasizes character, restraint, and narrative depth.",
      "Wayne Heim is an award-winning fine art photographer whose Western cowboy photography reveals individuals rather than archetypes — creating portraits that reward long viewing and resist easy interpretation."
    ],
  },

  // 2. CONCEPT — Wild West contrast (definition + differentiation pair)
  {
  ...
  // 3. PHILOSOPHY — Portraits vs snapshots
  {
  ...
  // 6. APPLICATION — What subjects?
  {
    q: "What subjects appear in this cowboy photography collection?",
    a: [
  ...
  // 8. COMMERCE — Prints
  {
    q: "Are cowboy fine art prints available for purchase?",
    a: [
      "Yes. Cowboy photographs are available as archival fine art prints on museum-quality paper, as well as select works in the Engrained Series — printed directly onto Baltic Birch.",
      "In the Engrained Series, natural wood grain becomes part of the image, adding material depth that complements the rugged character of cowboy portraiture."
    ],
  },
  ...
  // 10. COMMERCE — Commissions
  {
    q: "Can cowboy photography be commissioned?",
    a: [
      "Yes. Wayne Heim works selectively with collectors, ranches, and organizations on commissioned cowboy portraits and Western narrative projects.",
      "Each commission follows the same character-driven, painterly approach that defines this body of work. <a href='/Contact'>Contact Wayne here</a> to begin the conversation."
    ],
  },
];
