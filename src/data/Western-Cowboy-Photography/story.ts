export const cowboyStory = [
  ...
  // 2. WILD WEST COWBOY PHOTOGRAPHY — BEYOND THE MYTH
  {
  ...
  // 3. COWBOY PORTRAITS AS CHARACTER STUDIES
  {
    subhead: "Cowboy Portraits as Character Studies",
    paragraphs: [
      ...
      "Wayne Heim's cowboy photography treats each subject as an individual first. The Western context shapes the frame, but the person fills it. What emerges is cowboy portraiture that rewards long viewing and resists easy interpretation."
    ]
  },
  ...
  // 5. THE ONE-IMAGE MOVIE™ APPROACH
  {
  ...
  // 6. PAINTERLY CRAFT IN COWBOY PHOTOGRAPHY
  {
  ...
  // 7. COWBOY PHOTOGRAPHY FOR COLLECTORS
  {
  ...
  // 8. WILD WEST WALL ART WITH MEANING
  {
  ...
  // 9. WHY COWBOY PHOTOGRAPHY MATTERS
  {
