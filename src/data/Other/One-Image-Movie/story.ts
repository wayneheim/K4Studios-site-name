export const oneImageMoviePage = {
  ...
  sections: [
    ...
    // 3. WHAT DEFINES A ONE-IMAGE MOVIE
    {
    ...
    // 8. WHY COLLECTORS VALUE IT
    {
      ...
      paragraphs: [
        `Collectors often describe these images as "scenes from a film I somehow remember" or "a moment I can feel but can't explain." That emotional imprint is the signature of a One-Image Movie™.`,
        `The Edition Ladder—Sketches, Foundation, Chronicle, Legends, and Engrained—further elevates the medium, offering collectors a structured way to own not just a print, but a piece of the evolving narrative canon Wayne is building.`
      ]
    },
