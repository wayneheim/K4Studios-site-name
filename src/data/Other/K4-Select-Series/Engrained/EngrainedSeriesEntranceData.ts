...
export const entranceData = {
  ...
  details:
    "The Engrained Series features award-winning painterly photography printed directly onto 1/2\" Baltic birch hardwood, using a proprietary multi-layered UV process for exceptional color, depth, and selective transparency. Discover Western portrait art, Civil War scenes, landscapes, historic trains, cowboy iconography, and rustic Americana—each panel is ready to hang with a float-mount bracket, or frame for added presence. Selected Engrained works are drawn from the broader <a href=\"/Painterly-Western-Photography\">Painterly Western Photography collection</a> and translated onto Baltic Birch for added material presence. Key features: wood print wall art, Western home decor, historical fine art, rustic Americana, painterly cowboy portraits, Western landscape photography, artisan craftsmanship, collector's limited edition, and unique art for your home, cabin, or gallery. Each wood print is signed, numbered, and limited to 50 in the series.",
  image: {
