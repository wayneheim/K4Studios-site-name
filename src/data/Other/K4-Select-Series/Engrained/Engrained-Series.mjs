...
export const galleryData = [
  {
    ...
    "description": "Step inside the Engrained Series: painterly fine art and Western photography, uniquely printed into selected wood panels with Wayne Heim's custom UV layering process. Every grain carries part of the story.",
    "alt": "Welcome to the Engrained Series - painterly fine art printed into selected wood panels",
  ...
  },
  {
    ...
    "notes": "Movement becomes meaning here—the figures are not simply posed, but carried into the moment by momentum. The diagonal sweep of fabric and posture gives the embrace a sense of arrival that feels earned rather than staged.\n\nThis approach reflects a lineage within Western art that treats intimacy as consequence, not sentiment. The environment remains present but secondary, allowing the emotional gravity to center on human connection shaped by distance and endurance. The result is a piece that holds both motion and stillness at once, inviting the viewer into the space where they meet.",
    "rating": 4,
  ...
  },
  {
    ...
    "keywords": [
      ...
      "wood print fine art",
      "printed on selected wood panels"
    ],
  ...
  },
  {
    ...
    "notes": "Care becomes the subject here—not as gesture, but as sustained attention. The image resists dramatization, instead grounding itself in repetition, discipline, and the weight of responsibility carried in small actions.\n\nThis aligns with traditions in wartime illustration and documentary portraiture where meaning is built through proximity rather than spectacle. The close framing and muted palette compress the space, allowing the viewer to feel the psychological pressure of the moment. It is a piece that holds tension quietly, revealing strength through endurance rather than display.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "What remains here is not activity, but presence—the kind that settles after motion has passed. The barn holds its place without insistence, shaped as much by time and weather as by intention.\n\nThis quiet endurance reflects a broader Western visual tradition where structures become markers of lived experience rather than focal spectacle. The surrounding land and distant peaks reinforce scale and isolation, allowing the image to balance narrative suggestion with restraint. It is a piece that invites reflection through atmosphere rather than action.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "Power is present here, but it is not chaotic—it is structured, channeled, and contained within the shape of the land. The falls carve their path with certainty, creating a visual anchor that holds the entire composition together.\n\nThis relationship between force and form reflects traditions in landscape art where movement is defined by its boundaries. The surrounding forest and canyon walls provide context and scale, allowing the viewer to feel both the energy of the water and the stability of the terrain. The image balances motion with permanence, offering a sense of awe grounded in structure.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "Isolation carries the weight here, not emptiness but intention. The structure is given room to exist without competition, allowing its presence to emerge through distance rather than detail.\n\nThis approach reflects a lineage of Western landscape work where meaning is shaped through restraint and placement. The open field, subtle elevation, and quiet sky create a psychological space as much as a physical one. The image invites reflection rather than response, offering a sense of stillness that expands rather than fills a room.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "The image withholds its subject just long enough to change how it is experienced. The grasses and edges take precedence, asking the viewer to move through the scene rather than immediately consume it.\n\nThis restraint reflects a lineage of landscape work where depth is discovered in layers instead of distance alone. Reflection, obstruction, and soft tonal control create a measured rhythm, encouraging a slower engagement. The result is a piece that reveals itself over time, rewarding patience with increasing clarity.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "There is a sense of earned presence here—the structure does not dominate the land, but settles into it, shaped by time and use. The mill feels less placed than absorbed, as if the terrain has allowed it to remain.\n\nThis relationship between architecture and environment echoes traditions found in both Western painting and early American illustration, where human structures are depicted as extensions of landscape rather than interruptions. The vertical drop, flowing water, and dense greenery create a layered composition that rewards slow viewing, revealing how stability can emerge from precarious ground.",
    "rating": 4,
  ...
  },
  {
    ...
    "story": "The cold settles in the grass before it ever reaches the bone, and the mountains hold what’s left of the day like they’re deciding whether to keep it. He moves anyway—steady, deliberate—like time belongs to him and not the other way around.\n\nNothing here asks permission. Not the peaks. Not the sky. Not him.\n\nHe lowers his head, takes another step, and the world adjusts around it.",
    "notes": "There is a quiet authority in the way the animal occupies the foreground—unforced, grounded, and entirely at ease within the scale of the land. The scene does not elevate the subject above the environment, but instead places it firmly within it.\n\nThis approach echoes traditions in Western landscape and wildlife art where presence is defined by relationship rather than dominance. The Tetons rise with a monumental stillness, while the bison introduces a living counterpoint—slow, steady, and enduring. The result is a piece that carries both weight and calm, offering a sense of permanence shaped by motion.",
    "rating": 5,
  ...
  },
  {
    ...
    "notes": "There is a quiet order to the way these trunks gather—repetition without rigidity, structure without force. The eye is guided upward, not by command, but by invitation.\n\nThe vertical framing recalls traditions in landscape painting that explore scale through perspective rather than distance. Each tree acts as both subject and line, creating a natural architecture that feels both intimate and expansive. The result is a piece that brings stillness upward into a space, offering calm without losing presence.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "Light becomes the subject here, not as spectacle, but as a gradual shift across surface and distance. The scene resists drama, instead allowing color and form to settle into a quieter, more enduring presence.\n\nThere is a strong connection to landscape traditions that value atmosphere over event, where the land is observed rather than interpreted. The layering of foreground grasses, mid-ground stone, and expansive sky creates depth without urgency, encouraging a slower, more reflective engagement. The image holds not in climax, but in continuation.",
    "rating": 4,
  ...
  },
  {
    ...
    "notes": "Tension enters before anything happens. The figures are already committed—each stance measured, each position deliberate—creating a shared sense of purpose without a single movement wasted.\n\nThe triangular grouping reinforces stability while quietly building pressure, a structure often seen in classical narrative painting. Rather than dramatizing action, the image holds itself in anticipation, allowing the viewer to feel the moment just before consequence. It’s this restraint—this refusal to resolve—that gives the work its staying power.",
    "rating": 5,
  ...
  },
  {
    ...
    "notes": "The vertical framing compresses the figure into a narrow field, reinforcing a sense of containment and inward focus. Rather than action, the composition leans on posture—the downward gaze, the resting hand—to carry narrative weight.\n\nThere is a quiet lineage here to portrait traditions that favor restraint over spectacle. The environment is not staged as backdrop but absorbed into the figure’s presence, allowing texture—wood, fabric, metal—to echo the psychological tone. The result is a piece that holds tension through stillness, inviting prolonged viewing rather than immediate resolution.",
    "rating": 4,
  ...
  },
  {
    ...
    "keywords": [
      ...
      "photography printed on wood",
      "wood print fine art",
      "engraved wood prints for rustic interiors",
      "printed on selected wood panels",
      "stories printed into wood",
      "wood panel art",
      "handcrafted wood wall art",
    ...
    "story": "Hooves thunder beneath me as smoke and banners fade into gray. I ride forward, heart pounding-a hero's journey carried by history and wood alike.",
