// File: data/Other/K4-Select-Series/Engrained/carousel.ts
...
export const slides = [
  {
    ...
    description: "Fine art painterly photograph of a vibrant Arizona sunset, with red rocks, green grass, and colorful clouds at the end of the day."
  },
  {
    id: "i-VGxwS5N",
    ...
    description: "Painterly fine art photograph of a tall Aspen grove beneath a crisp blue sky, uniquely printed on wood."
  },
  {
    id: "i-b4wG4vh",
    ...
    description: "Painterly photograph of a pink cotton candy cloud floating defiantly above a 55mph sign in the scenic roads of Jackson Hole, Wyoming."
  },
  {
    id: "i-xF7p92v",
    ...
    description: "Painterly fine art mountain landscape featuring Crystal Mill near Marble, Colorado, crafted in a unique wood print style."
  },
  {
    id: "i-thTwwHZ",
  ...
  },
  {
    ...
    description: "Classic rustic cowboy portrait capturing longing and reflection in a timeless Western painterly style."
  },
  {
    id: "i-mrHbrNb",
    ...
    description: "Cheerful Wild West cowboy captured in painterly style, savoring a morning coffee with a big smile."
  },
  {
    id: "i-VrbD648",
    ...
    description: "Dramatic fine art depiction of three cowboys, guns drawn, poised for a classic Western showdown."
  }
];
