export const facingFAQ = [
  ...
  // --- PHASE 4: New FAQs (Collector/Buyer Confidence) ---
  {
    q: "How long do archival fine art prints last?",
    a: [
      "Archival fine art prints are designed for permanence. Using museum-grade pigment inks and acid-free papers, properly displayed prints can retain their color and clarity for 100 years or more.",
      "Longevity depends on display conditions — avoiding direct sunlight, humidity, and temperature extremes. Framing behind UV-protective glass further extends the life of the work."
    ],
  },
  {
    q: "What's the difference between paper, metal, acrylic, and wood prints?",
    a: [
      "Each substrate carries its own character:",
      `<ul>
        <li><strong>Archival Paper:</strong> Classic fine art presentation. Warm tones, subtle texture, traditional framing. Best for collectors seeking museum-standard display.</li>
        <li><strong>Metal (Aluminum):</strong> Vivid, modern, durable. Colors pop with luminous depth. Suited for contemporary spaces and high-traffic environments.</li>
        <li><strong>Acrylic (Face-Mounted):</strong> Ultra-sharp, gallery-grade finish. The image floats behind polished acrylic for a dimensional, high-end presentation.</li>
        <li><strong>Baltic Birch Wood (Engrained Series):</strong> The natural wood grain becomes part of the image. Warm, tactile, and entirely unique to each print.</li>
      </ul>`,
      "Each format is produced on demand with archival materials. The right choice depends on your space, aesthetic, and how you want the work to live in your environment."
    ],
  },
  {
    q: "What sizes work best for different spaces?",
    a: [
      "Size recommendations depend on viewing distance and the role the artwork plays in the room:",
      `<ul>
        <li><strong>12×18 to 16×24:</strong> Intimate studies — bedrooms, offices, hallways, or grouped arrangements.</li>
        <li><strong>20×30 to 24×36:</strong> Anchor pieces — living rooms, libraries, above furniture.</li>
        <li><strong>30×45 and larger:</strong> Statement works — great rooms, lobbies, over mantels, commercial installations.</li>
      </ul>`,
      "When in doubt, go larger than you think. Fine art is meant to command attention, not disappear into the wall."
    ],  }
];