export const semantic = {
  mainKeywords: [
    ...
    "award-winning historical photography", "legacy portraits", "visual storytelling", "american history wall art",

    // *** NEW: Painterly, Landscape, Transportation ***
  ...
  linkOverrides: [
    ...
    "The Roaring 20s: Bold & Unforgettable",
    "Outlaws and Cowboys",
    "Visual Storytelling",
    "Award-winning historical photography",
    "Legacy portraits",
