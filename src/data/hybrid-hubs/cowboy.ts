...
export const pageMeta = {
  ...
  description:
    'Collector-focused selection of cowboy, frontier, and narrative western art prints by Wayne Heim. Painterly limited-edition works on archival paper, canvas, and Engrained wood panels, built for exhibition and long-term collecting.',
  ogImage: 'i-ncFcHDM',
};
