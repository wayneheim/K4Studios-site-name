export const painterlyStory = [
  ...
  // 1. OPENING - GALLERY/COLLECTION INTENT (Quill-approved)
  {
    ...
    paragraphs: [
      ...
      "These works explore the historical and psychological frontier — the atmosphere, character, and lived narratives of the American West — rather than ordinary documentary coverage or modern Western lifestyle photography.",
