export const landingCowboy = {
  // Cowboy Fine Art Photography - PRIMARY AUTHORITY HUB for "cowboy" as subject
  title: "Cowboy Fine Art Photography",
  subtitle: "Portraits, Character Studies & Black and White Cowboy Photography",
