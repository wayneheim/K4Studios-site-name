export const painterlyStory = [
  ...
  // 1. DEFINITION BLOCK (anchor paragraph for AI scraping)
  {
    ...
    paragraphs: [
      ...
      "The wider historical environment surrounding that subject opens into <a href='/Fine-Art-Photography-of-the-American-West'>Fine Art Photography of the American West</a>, where the region is treated as a full narrative landscape rather than a Western subject category alone.",
