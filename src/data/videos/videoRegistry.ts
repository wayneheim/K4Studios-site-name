...
export const videos: K4Video[] = [
  {
    slug: "only-path-forward",
    title: "Only Path Forward | Painterly Western Fine Art Photography",
    youtubeId: "y5v4m-yLlio",
    externalUrl: "https://www.youtube.com/watch?v=y5v4m-yLlio",
    ...
    thumbnailAlt: "Cinematic Western fine art photography video titled Only Path Forward.",
    dek: "A cinematic Western fine art story built from still photographs, narration, titles, and the hard momentum of consequence.",
    description:
      "Only Path Forward is a K4 Studios Western fine art video by Wayne Heim, built from painterly still photographs, narration, music, and titles. The piece turns gunsmoke, old debts, mercy, and consequence into a compact One-Image Movie style story where the photographs hold still and the viewer's mind completes the motion.",
    relatedLinks: [
      ...
      { label: "K4 Studios Video Stories on YouTube", href: K4_YOUTUBE_VIDEOS_URL },
      { label: "Watch on YouTube", href: "https://www.youtube.com/watch?v=y5v4m-yLlio" },
    ],
    metadataSource: "manual",
    metadataSyncedAt: "2026-06-10",
  },
  {
    slug: "only-path-forward-short",
    title: "Only Path Forward Short",
    youtubeId: "srvn8EfGM2c",
    externalUrl: "https://www.youtube.com/shorts/srvn8EfGM2c",
    type: "Narrative Mini Movie",
    theme: "Wild West",
    date: "2026-06-10",
    ...
    relatedLinks: [
      ...
      { label: "Watch on YouTube", href: "https://www.youtube.com/shorts/srvn8EfGM2c" },
    ],
    metadataSource: "manual",
    metadataSyncedAt: "2026-06-10",
  },
