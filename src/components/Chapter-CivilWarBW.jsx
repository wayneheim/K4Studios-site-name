...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  return (
    ...
    >
                ...
                >
                  ...
                  <div className="flex flex-col -mt-4 items-center w-full relative">
                    ...
                    >
                      ...
                      {/* Chapter/total */}
                      <div
                        className="text-sm text-gray-500 font-medium flex items-center whitespace-nowrap"
      ...
      <SwipeHint galleryKey="Painterly-CivilWar-BlackWhite" />
    </div>
  );
}
