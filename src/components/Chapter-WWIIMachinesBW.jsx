...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    const basePath = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Machines/Black-White";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Machines/Black-White";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint */}
       <SwipeHint galleryKey="WWII-Machines-Black-White" />
    </div>
  );
}
