...
// International dataset (data point 1)
...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  // 🔗 Update URL when navigating *after* entering chapters (data point 2: International path)
  useEffect(() => {
  ...
  const basePath = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/International/Gallery";
  ...
  // 🧼 Clean up stray ID in URL if landing intro is showing (data point 3: International clean URL)
  useEffect(() => {
  ...
  const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/International/Gallery";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint (data point 5: International key) */}
      <SwipeHint galleryKey="Painterly-Landscapes-International" />
    </div>
  );
}
