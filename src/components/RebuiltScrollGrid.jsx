...
useEffect(() => {
  ...
  onMouseEnter={(e) => {
    e.currentTarget.style.transition = "transform 5.29s ease-out";
    e.currentTarget.style.transform =
      "scale(1.1) translate(-4%, -4%) rotate(-1.2deg)";
  }}
  onMouseLeave={(e) => {
    e.currentTarget.style.transition = "transform 0.051s ease-in";
