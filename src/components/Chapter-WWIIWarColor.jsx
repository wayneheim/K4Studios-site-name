...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    const basePath = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/War/Color";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/War/Color";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint */}
       <SwipeHint galleryKey="WWII-War-Color" />
    </div>
  );
}
