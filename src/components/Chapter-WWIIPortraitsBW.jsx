...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    const basePath = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits/Black-White";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits/Black-White";
 ...
 {/* ❤️ Like Button (Desktop in button row) */}
  {!isMobile && (
    <div className="inline-flex items-center px-2">
      ...
      {/* Swipe Hint */}
       <SwipeHint galleryKey="WWII-Portraits-Black-White" />
    </div>
  );
}
