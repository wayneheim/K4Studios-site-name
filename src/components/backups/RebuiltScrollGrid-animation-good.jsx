...
<div className="mb-[-3rem] z-20 relative flex items-center justify-center gap-10">
  <div className="fade-line" />
  <h2 className="watermark-title whitespace-nowrap">Chapter Index</h2>
  <div className="fade-line" />
</div>

      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mr-0 mx-auto mt-20">
