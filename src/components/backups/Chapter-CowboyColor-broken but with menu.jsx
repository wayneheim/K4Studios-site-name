...
import MiniMobileMenuTrigger from "../components/MiniMobileMenuTrigger.jsx";
import MobileMiniDrawer from "../components/MobileMiniDrawer.jsx";
import useForceMobileMenu from "../components/hooks/useForceMobileMenu.js";
...
export default function ScrollFlipGallery() {
  const forceMobile = useForceMobileMenu(); // injects `.force-mobile-menu` into <body>
                ...
                >
                  <div className="flex flex-col items-center w-full relative">
                    <div className="flex justify-center -mt-4 mb-2 gap-2">
                      <>
  <div className="chapter-menu-bar">
    <MiniMobileMenuTrigger onClick={() => setShowMiniMenu(true)} />
    {showMiniMenu && (
