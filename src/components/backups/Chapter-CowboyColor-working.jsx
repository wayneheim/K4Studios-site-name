...
export default function ScrollFlipGallery() {
  ...
  className="relative w-7 h-7 flex items-center justify-center font-bold text-gray-600 bg-gray-200 border border-gray-300 rounded shadow transition hover:bg-gray-400 hover:text-white"
