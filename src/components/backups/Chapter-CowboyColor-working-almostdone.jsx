                  ...
                  <div className="flex flex-col -mt-4 items-center w-full relative">
                    ...
                    <div className="w-full relative flex items-center justify-center mb-0">
                      ...
                      <button
                        ...
                        className="absolute left-6 top-2/2 -translate-y-1/2 z-20 text-gray-300 bg-gray-100 rounded-md shadow px-3 py-1 text-xl md:hidden"
          ...
          >
            ...
            <p>{galleryData[currentIndex].notes}</p>
                      ...
                      <button
                        ...
                        className="absolute right-6 top-2/2 -translate-y-1/2 z-20 bg-gray-100 text-gray-300 rounded-md shadow shadow px-3 py-1 text-xl md:hidden"
                        style={{ minWidth: 38, display: isMobile ? 'block' : 'none' }}
                        tabIndex={isMobile ? 0 : -1}
                      >
                        &gt;
