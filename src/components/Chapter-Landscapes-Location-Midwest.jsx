...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  // 🔗 Update URL when navigating *after* entering chapters (data point 2: Midwest path)
  useEffect(() => {
  ...
  const basePath = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/Midwest/Gallery";
  ...
  // 🧼 Clean up stray ID in URL if landing intro is showing (data point 3: Midwest clean URL)
  useEffect(() => {
  ...
  const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/Midwest/Gallery";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint (data point 5: Midwest key) */}
      <SwipeHint galleryKey="Painterly-Landscapes-Midwest" />
    </div>
  );
}
