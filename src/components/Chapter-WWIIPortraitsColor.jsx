...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    const basePath = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits/Color";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Facing-History/WWII/Portraits/Color";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint */}
       <SwipeHint galleryKey="WWII-Portraits-Color" />
    </div>
  );
}
