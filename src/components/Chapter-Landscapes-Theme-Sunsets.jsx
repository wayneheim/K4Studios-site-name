...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  const basePath = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Theme/Sunsets";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Theme/Sunsets";
 ...
 {/* ❤️ Like Button (Desktop in button row) */}
  {!isMobile && (
    <div className="inline-flex items-center px-2">
      ...
      {/* Swipe Hint */}
      <SwipeHint galleryKey="Painterly-Landscapes-Sunsets" />
    </div>
  );
}
