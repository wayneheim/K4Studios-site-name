            ...
            {isEndOfStory ? (
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-10">
                  {rawData.filter(img => img.id !== "i-k4studios").map((img, idx) => (
                    <a
                      key={idx}
                      href={img.galleries && img.galleries.length > 0 ? `/Galleries/${img.galleries[0].replace('Galleries/', '')}/${img.id}` : "#"}
                ...
                {currentIndex === 0 ? (
                  <div className="relative">
                    <motion.div
                      ...
                      onClick={goNext}
                      className="rounded-xl border border-gray-300 pt-12 px-6 pb-4 shadow-lg cursor-pointer flex flex-col will-change-transform max-w-md mx-auto hover:bg-[#f0e6d2] transition-all duration-200 group relative z-10"
                    ...
                    >
                      ...
                      <div className="flex justify-center mt-4">
                        <button
                          type="button"
                          onClick={goNext}
                          className="w-16 h-16 flex items-center justify-center text-gray-400 group-hover:text-[#8B4513] rounded transition-all duration-200"
                          title="Begin Story"
                        >
                    ...
                    <div className="absolute inset-0 -mt-2">
                      {/* Card 1 */}
                      <div
                        className="absolute rounded-xl border border-gray-300 bg-[#f7f3eb] shadow-lg max-w-md mx-auto opacity-60"
                        style={{
                          width: 'calc(100% - 8px)',
                          height: 'calc(100% - 8px)',
                      ...
                      {/* Card 2 */}
                      <div
                        className="absolute rounded-xl border border-gray-300 bg-[#f7f3eb] shadow-lg max-w-md mx-auto opacity-40"
                        style={{
                          width: 'calc(100% - 16px)',
                          height: 'calc(100% - 16px)',
                          transform: 'rotate(1deg) translateX(2px) translateY(8px)',
                          zIndex: -2
                        }}
                      />
                      {/* Card 3 */}
                      <div
                        className="absolute rounded-xl border border-gray-300 bg-[#f7f3eb] shadow-lg max-w-md mx-auto opacity-25"
                        style={{
                          width: 'calc(100% - 24px)',
                      ...
                      {/* Card 4 */}
                      <div
                        className="absolute rounded-xl border border-gray-300 bg-[#f7f3eb] shadow-lg max-w-md mx-auto opacity-15"
                        style={{
                          width: 'calc(100% - 32px)',
                          height: 'calc(100% - 32px)',
                          transform: 'rotate(0.5deg) translateX(4px) translateY(16px)',
                          zIndex: -4
                        }}
                      />
                      {/* Card 5 */}
                      <div
                        className="absolute rounded-xl border border-gray-300 bg-[#f7f3eb] shadow-lg max-w-md mx-auto opacity-10"
                        style={{
                          width: 'calc(100% - 40px)',
                          height: 'calc(100% - 40px)',
                          transform: 'rotate(-0.5deg) translateX(-2px) translateY(20px)',
                          zIndex: -5
                        }}
                      />
                    </div>
