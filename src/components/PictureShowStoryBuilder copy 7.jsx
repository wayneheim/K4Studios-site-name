            ...
            {editData.id !== "i-k4studios-closing" && editData.visibility !== "closing" && (
              <div style={{ marginBottom: 10 }}>
                ...
                <input
                  ...
                  style={!!showMeta.globalAudioSrc ? { opacity: 0.5, cursor: "not-allowed" } : {}}
                />
                <div style={{ fontSize: 12, opacity: 0.7, marginTop: 4 }}>
                  {showMeta.globalAudioSrc
                    ? <span style={{ color: "#888" }}>Background audio is set for the show. Per-image audio is disabled.</span>
