...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  useEffect(() => {
    ...
    const basePath = "/Galleries/Painterly-Fine-Art-Photography/Transportation/Trains-Color";
  ...
  useEffect(() => {
    ...
    if (isIntroVisible && isViewingImageZero && window.location.pathname.includes("/i-")) {
      const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Transportation/Trains-Color";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint */}
       <SwipeHint galleryKey="Transportation-Trains-Color" />
    </div>
  );
}
