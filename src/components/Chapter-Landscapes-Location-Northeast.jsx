...
// Northeast dataset (data point 1)
...
export default function ScrollFlipGallery({ initialImageId }) {
  ...
  // 🔗 Update URL when navigating *after* entering chapters (data point 2: Northeast path)
  useEffect(() => {
  ...
  const basePath = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/Northeast/Gallery";
  ...
  // 🧼 Clean up stray ID in URL if landing intro is showing (data point 3: Northeast clean URL)
  useEffect(() => {
  ...
  const cleanUrl = "/Galleries/Painterly-Fine-Art-Photography/Landscapes/By-Location/Northeast/Gallery";
...
{showStoryShow && (
  ...
  />
      ...
      {/* Swipe Hint (data point 5: Northeast key) */}
      <SwipeHint galleryKey="Painterly-Landscapes-Northeast" />
    </div>
  );
}
