...
import { galleryData } from "../data/galleries/Painterly-Western-Cowboy-Portraits/BlackWhite";

// Only ONE function!
export default function ScrollFlipGallery({ returnUrl }) {
...
>
  <Grid className="w-5 h-5" style={{ stroke: "#84766d" }} />
                      ...
                      <button
                        ...
                        title="Close"
                        style={{ minWidth: 32, minHeight: 32, fontWeight: 400 }}
                       onClick={() => window.location.href = returnUrl || "/Galleries/Painterly-Fine-Art-Photography/Facing-History/Western-Cowboy-Portraits/Black-White"}
                      >
                        ⨂
                      </button>
                    </div>
