...
const CANONICAL_LINK_MAP: Record<string, string> = {
  ...
  'black and white cowboy photos': '/Western-Black-and-White-Photography',
  'black white cowboy pictures': '/Western-Black-and-White-Photography',
  ...
  'western photo': '/western-photos',
  'western pictures': '/western-photos',
  ...
  'western portraits': '/western-portrait-photography',
  'western landscape photography': '/western-photos',
