...
/* ─── Gray out all tiles except the hovered one ─────────────── */

/* Default transition for every tile (controls fade back in) */
.tile-grid .tile {
  transition: filter 0.7s ease-out;
}

/* When hovering over the grid, dim all tiles */
.tile-grid:hover .tile {
  filter: grayscale(100%) brightness(0.68);
  transition: filter 0.3s ease-in; /* quick dim on hover */
}

/* Keep hovered tile crisp and bring it forward */
